                        ...
                        <div class="col-xl-8">
                            ...
                            <form class="needs-validation" action="/admin/tps" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" id="nama" name="nama" placeholder="masukan nama tps">
                                    @error('nama')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror" value="{{ old('lokasi') }}" id="lokasi" name="lokasi" placeholder="masukan lokasi tps">
                                    @error('lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
