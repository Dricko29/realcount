        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">Input Data Polling</h4>
                @if (session('status'))
                ...
                @endif
                    <form class="needs-validation" action="/admin/polling" method="post">
                        @csrf
                            <div class="mb-3">
                                <input type="hidden" id="kode_polling" class="form-control @error('kode_polling') is-invalid @enderror"  value=""  name="kode_polling">
                                @error('kode_polling')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('jumlah_suara') is-invalid @enderror"  value="{{ old('jumlah_suara') }}" id="jumlah_suara" name="jumlah_suara" placeholder="masukan jumlah suara sah">
                                @error('jumlah_suara')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
